...
const Topbar = () => {
  return (
    <div className='bg-[#7E33E0] w-full md:flex items-center justify-between'>
      <div className='max-w-[1920] mx-auto flex items-center justify-center gap-6 p-2'>
       <div className='relative'>
       <p className='text-[#F1F1F1] text-xs font-semibold gap-4'>
        <a href='mailto:mhhasanul@gmail.com' className='flex space-x-6'>
       ...
       <div className='relative'>
       <p className='text-[#F1F1F1] text-xs font-semibold gap-4'>
       <a href='tel:(12345)67890' className='flex space-x-6'>
      ...
      <div className='max-w-[1920] mx-auto flex items-center justify-center gap-3 p-2'>
